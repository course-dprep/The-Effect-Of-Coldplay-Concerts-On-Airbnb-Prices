...
In our research we study the price changes of Airbnb's in different cities in the period of a Coldplay concert of the worldtour 'Music of the Spheres'. We will look at the prices during a Coldplay concert and compare those to prices in the month before and after the concerts to study the price differences caused by the Coldplay concerts. Furthermore, we will look at the influence of the type of listing, and the influence of the distance between an Airbnb and the place of the concert on the relationship of the concert on the price of the Airbnb.
...
Airbnb prices can differ over time. Setting the right price can be difficult. Yet, it is beneficial to both Airbnb as well as the the people who list their property to set the right price. Therefore it is important to know what affects Airbnb prices. Do big events in the area of Airbnb's increase prices? To answer this question, the Coldplay tour "World of the Spheres" and its effect in different cities is analyzed. With the retrieved data, it is possible to adress the effect of big events on price changes for Airbnb. 
