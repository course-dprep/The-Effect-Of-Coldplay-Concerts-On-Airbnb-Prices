...
Chicago
![Chicago distance to stadium with relation to price graph](gen/output/graph/Chicago/Chicago_distance_price_graph.png)
![Chicago mean price during concert](gen/output/graph/Chicago/Chicago_mean_price_graph.png)
![Chicago difference in price for room types](gen/output/graph/Chicago/Chicago_room_type_graph.png)
Dallas 
![Dallas distance to stadium with relation to price graph](gen/output/graph/Dallas/Dallas_distance_price_graph.png)
![Dallas mean price during concert](gen/output/graph/Dallas/Dallas_mean_price_graph.png)
![Dallas difference in price for room types](gen/output/graph/Dallas/Dallas_room_type_graph.png)

Mexico 
![Mexico distance to stadium with relation to price graph](gen/output/graph/Mexico/Mexico_distance_price_graph.png)
![Mexico mean price during concert](gen/output/graph/Mexico/Mexico_mean_price_graph.png)
![Mexico difference in price for room types](gen/output/graph/Mexico/Mexico_room_type_graph.png)
